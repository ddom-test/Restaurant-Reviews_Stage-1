...
This project is part of the Front-End Web Developer Nanodegree Program. For the **Restaurant Reviews** projects, the aim is to incrementally convert a static webpage to a mobile-ready web application.  
